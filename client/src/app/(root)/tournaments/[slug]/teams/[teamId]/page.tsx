      ...
      <div className="mt-4 overflow-hidden rounded-lg border">
        <table className="w-full min-w-[900px] text-left text-sm">
          <thead className="bg-slate-100 text-xs uppercase text-slate-500">
            <tr><th className="px-4 py-3">Name</th><th className="px-4 py-3">Role</th><th className="px-4 py-3">Phone</th><th className="px-4 py-3">Price</th><th className="px-4 py-3">Assigned by</th><th className="px-4 py-3">Assigned at</th></tr>
          </thead>
          <tbody>
            {squad.map((item) => (
            ...
            {!squad.length ? (
              <tr className="border-b bg-white">
                <td className="px-4 py-8 text-center text-slate-500" colSpan={6}>No players assigned to this team yet.</td>
              </tr>
            ) : null}
          </tbody>
        </table>
